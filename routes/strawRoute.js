...
const router = Router();
const { postStraw,countPlastic,countSUP,groupPlasticCount,rawCountSaved,getAllPlastic, allSUPIds,allSavedIds,deleteSavedPlastic,postSaved } = require('../controllers/strawCtrl');
